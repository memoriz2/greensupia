...
export default function SupportPage() {
  ...
  return (
    <div className="greensupia-page">
      {/* 탑배너 */}
      <section className="greensupia-page__banner greensupia-page__banner--full greensupia-support__banner">
        <Image
          src="/request_tbanner.jpg"
          alt="고객지원"
          width={1905}
          height={400}
          priority
          className="greensupia-page__banner-image greensupia-support__banner-image"
          style={{ height: 'auto' }}
        />
      </section>
